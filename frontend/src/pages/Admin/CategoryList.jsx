...
const CategoryList = () => {
    ...
    const handleDeleteCategory = async () => {
        try {
            ...
            console.log(error)
            toast.error('Categorry deletion failed. Try again')
        }
    }
    return (
        <div className="ml-[10rem] flex flex-col md:flex-row">
            ...
            <div className="md:w-3/4 p-3">
                ...
                <Modal isOpen={modalVisible} onClose={() => setModalVisible(false)}><CategoryForm value={updatingName} setValue={value => setUpdatingName(value)} handleSubmit={handleUpdateCategory} buttonText="Update" handleDelete={handleDeleteCategory} />  </Modal>
            </div>
        </div>
    )
}
